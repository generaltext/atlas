...
// runs — inside General Text, and in `pnpm dev` where a vite plugin injects it. So
// a real runtime is present iff window.gt exists right now. Opened standalone on
// the deployed site there's none, so we show a splash and let the visitor load a
// LOCAL in-browser workspace to try the demo.
