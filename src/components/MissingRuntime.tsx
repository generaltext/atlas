...
export function MissingRuntime({ onTryDemo }: { onTryDemo: () => void }) {
  const appUrl =
    typeof window !== 'undefined' ? window.location.origin : 'https://atlas.generaltext.org'
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <p className="text-xs" style={{ color: 'var(--muted)' }}>
              A General Text app · projects, clients &amp; living reports
            </p>
          </div>
        </div>
        ...
        <p className="-mt-1 text-xs" style={{ color: 'var(--muted)' }}>
          The demo loads a sample studio locally in your browser. Nothing is saved to an account,
          and changes stay on this device.
        </p>
